    ...
    inquirer.prompt([
        ...
        .then(answer => {
            ...
            connection.query(grabDept, (err, res) => {
                ...
                const dept = res.map(({deptName, id}) => ({name: deptName, value: id}))
            ...
            .then((answer) => {
                ...
                connection.query(managerSQL, (err, res) => {
                    ...
                    .then(answer => {
                        ...
                        const sql = `INSERT into employee (firstName, lastName, roleID, mangagerID)
                        VALUES (?, ?, ?, ?)`
...
function updateEmployee() {
    ...
    connection.query(sql, (err, res) => {
        ...
        const employeeList = res.map(({id, firstName, lastName}) => ({name: `${firstName} ${lastName}`, value: id}))
...
function viewByDept() {
    ...
    connection.query(sql, (err, res) => {
        ...
        const departments = res.map(({id, deptName}) => ({name: deptName, value: id}))
